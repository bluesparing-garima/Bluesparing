...
const MonthlyCompanyFilterPayInLeftDistributed = () => {
  ...
  const handleDownloadExcel = () => {
    generateBrokerPayInLeftDistributedCompanyExcel(companyDetails);
  };
  ...
  const filterMonthlyBrokerPaymentWithCompany = async (
    ...
    GetMonthlyBrokerWithLeftDistributedCompanyPaymentService({
      header,
      brokerId: brokerId!,
      startDate: startDate,
      endDate: endDate,
...
export default MonthlyCompanyFilterPayInLeftDistributed;
