...
const MonthlyFilterPayOutLeftDistributed = () => {
  const title = "Get Monthly Payout Left Distributed Details Of All Partners";
          ...
          {partnerPayment.map((item, index) => (
            <Grid item xs={12} sm={6} md={4} lg={4} key={index}>
              <Link
                ...
                to={`/payouts/monthly/leftDistributed/company/${selectedStartDate}/${selectedEndDate}/${item.partnerId}`}
              >
...
export default MonthlyFilterPayOutLeftDistributed;
