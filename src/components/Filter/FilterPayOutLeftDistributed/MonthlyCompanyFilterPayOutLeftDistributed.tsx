...
import { ICompanyLeftDis } from "../../TreeView/ITreeView";
import { generateCompanyLeftDisExcel } from "../../../utils/DashboardExcel";
const MonthlyCompanyFilterPayOutLeftDistributed = () => {
  const title = "Get Monthly Left Distributed Payment Details Of Partner -";
  ...
  const filterMonthlyPartnerPaymentWithCompany = async (
    ...
    GetMonthlyLeftDistributionCompanyService({
      header,
      partnerId: partnerId!,
      startDate: startDate,
      endDate: endDate,
...
export default MonthlyCompanyFilterPayOutLeftDistributed;
