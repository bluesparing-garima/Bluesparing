...
import GetPartnerPolicyDataService from "../../../api/Dashboard/GetPartnerPolicyData/GetPartnerPolicyDataService";
...
const PartnerPolicyChart = ({ partnerId }: any) => {
  ...
  const fetchData = async (filter: string) => {
    ...
    try {
      const commissions = await GetPartnerPolicyDataService({
        header,
        filter,
        partnerId: partnerId,
      });
...
export default PartnerPolicyChart;
