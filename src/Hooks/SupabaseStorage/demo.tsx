...
// import { useSupabaseStorage } from "../../../Hooks/SupabaseStorage/useSupabaseStorage";
...
//   const { uploadFile, getFileUrl } = useSupabaseStorage();
...
//     const filePath = await uploadFile("documents", file); // "documents" is your bucket name
//     if (!filePath) {
//       setErrors((prev) => {
//         const newErrors = [...prev];
//         newErrors[index] = {
...
//     // Update state with Supabase file path
//     const updatedDocuments = [...documents];
//     updatedDocuments[index] = { ...updatedDocuments[index], file: filePath };
//     setDocuments(updatedDocuments);
//   };

//   const handleClickViewDocument = async (filePath: string) => {
//     const publicUrl = await getFileUrl("documents", filePath);
//     if (publicUrl) {
...
//                                       component="span"
//                                       onClick={() =>
//                                         handleClickViewDocument(doc.file)
//                                       }
//                                     >
//                                       <svg
